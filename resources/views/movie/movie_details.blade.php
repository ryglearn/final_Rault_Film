...
<head>
    ...
    <title>Rault Film | Detail Movie</title>
</head>
...
<body>
    <div class="w-full h-screen flex flex-col relative">
        ...
        @php
            ...
            if ($movieData) {
                $originalDate = $movieData->release_date;
        ...
        <div class="absolute z-10 w-full h-screen p-20 bg-black flex flex-col" id="trailerWrapper">
            <button class="ml-auto group mb-4" onclick="showTrailer(false)">
                <svg xmlns="http://www.w3.org/2000/svg" height="48" width="48">
                  <path d="m12.45 37.65-2.1-2.1L21.9 24 10.35 12.45l2.1-2.1L24 21.9l11.55-11.55 2.1 2.1L26.1 24l11.55 11.55-2.1 2.1L24 26.1Z" class="fill-white group-hover:fill-rault-500 duration-200"></path>
                </svg>
              </button>
              <iframe src="https://www.youtube.com/embed/{{ $trailerID }}?enablejsapi=1" id="youtubeVideo" title="{{ $movieData->title }} " frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen  class="w-full h-full" ></iframe>
        </div>
    </div>
