    ...
    <div class="w-full h-screen flex flex-col relative">
        ...
        <div class="w-full h-full z-10 flex flex-col justify-center px-20">
            ...
            <div class="flex flex-row">
                ...
                @if ($trailerID)
                    <button
                        class="w-fit bg-rault-500 text-white pl-4 pr-6 py-3 mt-5 font-inter text-xl flex flex-row rounded-lg items-center hover:drop-shadow-lg duration-200 mr-3"
                    ...
                    <a href="{{ route('watch', ['slug' => Str::slug($movieData->title)]) }}"
                        ...
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg" class="inline mr-2">
                            <path d="M4 2v20l18-10L4 2z" fill="white" />
                        </svg>
                        Tonton Film Ini
                    </a>
                @endif
        ...
        <div class="absolute z-10 w-full h-screen p-20 bg-black flex flex-col" id="trailerWrapper">
            ...
            <iframe src="https://www.youtube.com/embed/{{ $trailerID }}?enablejsapi=1" id="youtubeVideo"
                title="{{ $movieData->title }} " frameborder="0"
